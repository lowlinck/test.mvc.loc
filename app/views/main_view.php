      <div class="jumbotron">
        <h1>Тестовое задание</h1>
              <p><a class="btn btn-lg btn-success" href="/task" role="button">Смотреть!</a></p>
      </div>

      <div>
          <p class="lead"> Задачи состоят из:
              - имени пользователя;
              - е-mail;
              - текста задачи;
              ...
              Результат нужно развернуть на любом бесплатном хостинге, чтобы можно было посмотреть его в действии.</p>
      </div>
